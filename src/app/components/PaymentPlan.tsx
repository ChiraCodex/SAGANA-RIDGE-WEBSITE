    ...
    <main className="px-4 md:px-10 lg:px-20 my-20 flex flex-col gap-12">
      ...
      <div className="w-full">
        <h2 className="uppercase font-bold text-2xl md:text-3xl mb-4 text-brand-primary">
          Guide on Title Transfer Process
        </h2>
